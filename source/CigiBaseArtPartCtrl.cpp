                                 ...
                                 CigiCnvtInfoType::Type &CnvtInfo)
{
   ...
   if(CnvtVersion.CigiMajorVersion < 3)
      ...
      CnvtInfo.CnvtPacketID = CIGI_ART_PART_CTRL_PACKET_ID_V3;
   else
      CnvtInfo.CnvtPacketID = CIGI_ART_PART_CTRL_PACKET_ID_V4;
...
// Roll
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiBaseArtPartCtrl::SetRoll(const float RollIn, bool bndchk)
{
...
// Pitch
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiBaseArtPartCtrl::SetPitch(const float PitchIn, bool bndchk)
{
...
// Yaw
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiBaseArtPartCtrl::SetYaw(const float YawIn, bool bndchk)
{
