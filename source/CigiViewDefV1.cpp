...
CigiViewDefV1::CigiViewDefV1()
{
   ...
   PacketID = CIGI_VIEW_DEF_PACKET_ID_V1;
   PacketSize = CIGI_VIEW_DEF_PACKET_SIZE_V1;
   Version = 1;
   MinorVersion = 0;
...
// Pack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiViewDefV1::Pack(CigiBasePacket * Base, Cigi_uint8 * Buff, void *Spec) const
{
   double DBuf[6];
   ...
   *CDta.s++ = 0;
   ...
   memcpy(Buff,tBuf,CIGI_VIEW_DEF_PACKET_SIZE_V1);
...
// Unpack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiViewDefV1::Unpack(Cigi_uint8 * Buff, bool Swap, void *Spec)
{
   double DBuf[6];
   ...
   memcpy(tBuf,Buff,CIGI_VIEW_DEF_PACKET_SIZE_V1);
   ...
   TrackerAssigned = (HDta == 0) ? false : true;
...
// View ID
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiViewDefV1::SetViewID(const Cigi_uint8 ViewIDIn, bool bndchk)
{
...
// Group ID
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiViewDefV1::SetGroupID(const Cigi_uint8 GroupIDIn, bool bndchk)
{
