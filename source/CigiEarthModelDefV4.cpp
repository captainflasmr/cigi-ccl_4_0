 ...
 *  
 *  FILENAME:   CigiEarthModelDefV4.cpp
 *  LANGUAGE:   C++
 *  CLASS:      UNCLASSIFIED
...
CigiEarthModelDefV4::CigiEarthModelDefV4()
{

   PacketID = CIGI_EARTH_MODEL_DEF_PACKET_ID_V4;
   PacketSize = CIGI_EARTH_MODEL_DEF_PACKET_SIZE_V4;
   Version = 4;
   MinorVersion = 0;
...
// Pack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiEarthModelDefV4::Pack(CigiBasePacket * Base, Cigi_uint8 * Buff, void *Spec) const
{
   PackPointer CDta;
...
// Unpack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiEarthModelDefV4::Unpack(Cigi_uint8 * Buff, bool Swap, void *Spec)
{
   PackPointer CDta;
