 ...
 *  
 *  FILENAME:   CigiShortSymbolCtrlV4.cpp
 *  LANGUAGE:   C++
 *  CLASS:      UNCLASSIFIED
 ...
 *  Based on CigiShortSymbolCtrlV3_3.cpp
 *  
 * </pre>
...
CigiShortSymbolCtrlV4::CigiShortSymbolCtrlV4(void)
{
   PacketID = CIGI_SHORT_SYMBOL_CONTROL_PACKET_ID_V4;
   PacketSize = CIGI_SHORT_SYMBOL_CONTROL_PACKET_SIZE_V4;
   Version = 4;
   MinorVersion = 0;
...
// Pack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiShortSymbolCtrlV4::Pack(CigiBasePacket * Base, Cigi_uint8 * Buff, void *Spec) const
{
   PackPointer CDta;

   CigiShortSymbolCtrlV4 * Data =
      ( CigiShortSymbolCtrlV4 *)Base;
...
// Unpack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiShortSymbolCtrlV4::Unpack(Cigi_uint8 * Buff, bool Swap, void *Spec)
{
   PackPointer CDta;
   unsigned char HDta = 0;
