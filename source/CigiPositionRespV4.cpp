 ...
 *  
 *  FILENAME:   CigiPositionRespV4.cpp
 *  LANGUAGE:   C++
 *  CLASS:      UNCLASSIFIED
 ...
 *  Based on CigiPositionRespV3.cpp
 *
 * </pre>
...
CigiPositionRespV4::CigiPositionRespV4()
{

   PacketID = CIGI_POSITION_RESP_PACKET_ID_V4;
   PacketSize = CIGI_POSITION_RESP_PACKET_SIZE_V4;
   Version = 4;
   MinorVersion = 0;
...
// Pack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiPositionRespV4::Pack(CigiBasePacket * Base, Cigi_uint8 * Buff, void *Spec) const
{
   PackPointer CDta;
...
// Unpack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiPositionRespV4::Unpack(Cigi_uint8 * Buff, bool Swap, void *Spec)
{
   PackPointer CDta;
