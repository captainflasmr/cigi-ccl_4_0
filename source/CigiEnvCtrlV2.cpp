...
CigiEnvCtrlV2::CigiEnvCtrlV2()
{
   ...
   PacketID = CIGI_ENV_CTRL_PACKET_ID_V2;
   PacketSize = CIGI_ENV_CTRL_PACKET_SIZE_V2;
   Version = 2;
   MinorVersion = 0;
...
// Pack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiEnvCtrlV2::Pack(CigiBasePacket * Base, Cigi_uint8 * Buff, void *Spec) const
{
   double DBuf[6];
   ...
   *CDta.s++ = 0;
   ...
   CIGI_SCOPY4(CDta.f++, &Data->BaroPress);
   CIGI_SCOPY4(CDta.f++, &Data->Aerosol);


   memcpy(Buff,tBuf,CIGI_ENV_CTRL_PACKET_SIZE_V2);
...
// Unpack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiEnvCtrlV2::Unpack(Cigi_uint8 * Buff, bool Swap, void *Spec)
{
   double DBuf[6];
   ...
   memcpy(tBuf,Buff,CIGI_ENV_CTRL_PACKET_SIZE_V2);
   ...
   CIGI_SCOPY4(&BaroPress, CDta.f++);
   CIGI_SCOPY4(&Aerosol, CDta.f++);
...
// Hour
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiEnvCtrlV2::SetHour(const Cigi_uint8 HourIn, bool bndchk)
{
...
// Minute
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiEnvCtrlV2::SetMinute(const Cigi_uint8 MinuteIn, bool bndchk)
{
...
// Humidity
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiEnvCtrlV2::SetHumidity(const Cigi_uint8 HumidityIn, bool bndchk)
{
...
// Month
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiEnvCtrlV2::SetMonth(const Cigi_uint8 MonthIn, bool bndchk)
{
...
// Day
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiEnvCtrlV2::SetDay(const Cigi_uint8 DayIn, bool bndchk)
{
...
// Aerosol
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiEnvCtrlV2::SetAerosol(const float AerosolIn, bool bndchk)
{

#ifndef CIGI_NO_BND_CHK
   if(bndchk && (AerosolIn < 0.0))
   {
#ifndef CIGI_NO_EXCEPT
      throw CigiValueOutOfRangeException("Aerosol",(float)AerosolIn,">",0.0);
#endif
      return(CIGI_ERROR_VALUE_OUT_OF_RANGE);
   }
#endif
...
// Visibility
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiEnvCtrlV2::SetVisibility(const float VisibilityIn, bool bndchk)
{
...
// HorizWindSp
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiEnvCtrlV2::SetHorizWindSp(const float HorizWindSpIn, bool bndchk)
{
...
// WindDir
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiEnvCtrlV2::SetWindDir(const float WindDirIn, bool bndchk)
{
...
// BaroPress
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiEnvCtrlV2::SetBaroPress(const float BaroPressIn, bool bndchk)
{
