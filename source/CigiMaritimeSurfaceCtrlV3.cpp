...
CigiMaritimeSurfaceCtrlV3::CigiMaritimeSurfaceCtrlV3()
{
   ...
   PacketID = CIGI_MARITIME_SURFACE_CTRL_PACKET_ID_V3;
   PacketSize = CIGI_MARITIME_SURFACE_CTRL_PACKET_SIZE_V3;
   Version = 3;
   MinorVersion = 0;
...
// Pack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiMaritimeSurfaceCtrlV3::Pack(CigiBasePacket * Base, Cigi_uint8 * Buff, void *Spec) const
{
   PackPointer CDta;
...
// Unpack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiMaritimeSurfaceCtrlV3::Unpack(Cigi_uint8 * Buff, bool Swap, void *Spec)
{
   PackPointer CDta;
