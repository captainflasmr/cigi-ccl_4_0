...
CigiCollDetSegDefV1::CigiCollDetSegDefV1()
{

   PacketID = CIGI_COLL_DET_SEG_DEF_PACKET_ID_V1;
   PacketSize = CIGI_COLL_DET_SEG_DEF_PACKET_SIZE_V1;
   Version = 1;
   MinorVersion = 0;
...
// Pack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiCollDetSegDefV1::Pack(CigiBasePacket * Base, Cigi_uint8 * Buff, void *Spec) const
{
   double DBuf[6];
   ...
   *CDta.s++ = 0;
   ...
   memcpy(Buff,tBuf,CIGI_COLL_DET_SEG_DEF_PACKET_SIZE_V1);
...
// Unpack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiCollDetSegDefV1::Unpack(Cigi_uint8 * Buff, bool Swap, void *Spec)
{
   double DBuf[6];
   ...
   memcpy(tBuf,Buff,CIGI_COLL_DET_SEG_DEF_PACKET_SIZE_V1);
...
// SegmentID
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiCollDetSegDefV1::SetSegmentID(const Cigi_uint8 SegmentIDIn, bool bndchk)
{
