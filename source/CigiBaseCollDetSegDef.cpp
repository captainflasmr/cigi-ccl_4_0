 ...
 *  
 *  FILENAME:   CigiBaseCollDetSegDef.cpp
 *  LANGUAGE:   C++
 *  CLASS:      UNCLASSIFIED
...
CigiBaseCollDetSegDef::CigiBaseCollDetSegDef()
{
...
// GetCnvt
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiBaseCollDetSegDef::GetCnvt(CigiVersionID &CnvtVersion,
                    CigiCnvtInfoType::Type &CnvtInfo)
{
   ...
   if(CnvtVersion.CigiMajorVersion < 3)
      ...
      CnvtInfo.CnvtPacketID = CIGI_COLL_DET_SEG_DEF_PACKET_ID_V4;
