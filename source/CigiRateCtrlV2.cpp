...
CigiRateCtrlV2::CigiRateCtrlV2()
{

   PacketID = CIGI_RATE_CTRL_PACKET_ID_V2;
   PacketSize = CIGI_RATE_CTRL_PACKET_SIZE_V2;
   Version = 2;
   MinorVersion = 0;
...
// Pack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiRateCtrlV2::Pack(CigiBasePacket * Base, Cigi_uint8 * Buff, void *Spec) const
{
   double DBuf[6];
   ...
   *CDta.s++ = 0;
   ...
   memcpy(Buff,tBuf,CIGI_RATE_CTRL_PACKET_SIZE_V2);
...
// Unpack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiRateCtrlV2::Unpack(Cigi_uint8 * Buff, bool Swap, void *Spec)
{
   double DBuf[6];
   ...
   memcpy(tBuf,Buff,CIGI_RATE_CTRL_PACKET_SIZE_V2);
...
// SetArtPartID
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiRateCtrlV2::SetArtPartID(const Cigi_int8 ArtPartIDIn, bool bndchk)
{
   union ArtPartConv
   {
      Cigi_uint8 uc;
