 ...
 *  Based on CigiShortCompCtrlV3.cpp"
 *
...
const CigiBaseCompCtrl::CompAssocGrp CigiShortCompCtrlV4::CompClassV3xV1[CigiShortCompCtrlV4::CompClassCnvtSz] =
{
   Entity,  // EntityV3
   View,    // ViewV3
   NoCnvtV1, // ViewGrpV3
...
const CigiBaseCompCtrl::CompClassV2Grp CigiShortCompCtrlV4::CompClassV3xV2[CigiShortCompCtrlV4::CompClassCnvtSz] =
{
   EntityV2,  // EntityV3
   ViewV2,    // ViewV3
   ViewGrpV2, // ViewGrpV3
...
CigiShortCompCtrlV4::CigiShortCompCtrlV4()
{

   PacketID = CIGI_SHORT_COMP_CTRL_PACKET_ID_V4;
   PacketSize = CIGI_SHORT_COMP_CTRL_PACKET_SIZE_V4;
   Version = 4;
   MinorVersion = 0;
...
// Pack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiShortCompCtrlV4::Pack(CigiBasePacket * Base, Cigi_uint8 * Buff, void *Spec) const
{
   PackPointer CDta;
...
// Unpack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiShortCompCtrlV4::Unpack(Cigi_uint8 * Buff, bool Swap, void *Spec)
{
   PackPointer CDta;
...
// GetCnvt
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiShortCompCtrlV4::GetCnvt(CigiVersionID &CnvtVersion,
...
// CompClassV4
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiShortCompCtrlV4::SetCompClassV4(const CompClassV4Grp CompClassV4In, bool bndchk)
{
   ...
   if(bndchk && ((CompClassV4In < 0)||(CompClassV4In > 15)))
   {
      ...
      throw CigiValueOutOfRangeException("CompClassV4",(CompClassV4Grp)CompClassV4In,0,15);
#endif
...
// CompClassV3
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiShortCompCtrlV4::SetCompClassV3(const CompClassV3Grp CompClassV3In, bool bndchk)
{
...
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiShortCompCtrlV4::SetCompData(const Cigi_uint8 CompDataIn,
...
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiShortCompCtrlV4::SetCompData(const Cigi_int8 CompDataIn,
                    const unsigned int Word,
                    const BytePos Pos,
                    bool bndchk)
{
...
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiShortCompCtrlV4::SetCompData(const Cigi_uint16 CompDataIn,
                    const unsigned int Word,
...
// SetCompData - short
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiShortCompCtrlV4::SetCompData(const Cigi_int16 CompDataIn,
                    const unsigned int Word,
                    const HalfWordPos Pos,
                    bool bndchk)
{
...
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiShortCompCtrlV4::SetCompData(const Cigi_uint32 CompDataIn,
                const unsigned int Word,
                bool bndchk)
{
...
// SetCompData - long
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiShortCompCtrlV4::SetCompData(const Cigi_int32 CompDataIn,
                const unsigned int Word,
                bool bndchk)
{
...
// SetCompData - float
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiShortCompCtrlV4::SetCompData(const float CompDataIn,
                const unsigned int Word,
                bool bndchk)
{
...
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiShortCompCtrlV4::SetCompData(const Cigi_uint64 CompDataIn,
...
// SetCompData - double
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiShortCompCtrlV4::SetCompData(const double CompDataIn,
                const unsigned int Pos,
                bool bndchk)
{
...
// GetUCharCompData
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
Cigi_uint8 CigiShortCompCtrlV4::GetUCharCompData(const unsigned int Word,
                               const BytePos Pos)
{
...
// GetCharCompData
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
Cigi_int8 CigiShortCompCtrlV4::GetCharCompData(const unsigned int Word,
                     const BytePos Pos)
{
   union {
      Cigi_int8 sc;
...
// GetUShortCompData
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
Cigi_uint16 CigiShortCompCtrlV4::GetUShortCompData(const unsigned int Word,
                                 const HalfWordPos Pos)
{
   Cigi_uint16 tDta;
...
// GetShortCompData
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
Cigi_int16 CigiShortCompCtrlV4::GetShortCompData(const unsigned int Word,
                       const HalfWordPos Pos)
{
   union {
      Cigi_int16 s16;
...
// GetULongCompData
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
Cigi_uint32 CigiShortCompCtrlV4::GetULongCompData(const unsigned int Word)
{
...
// GetLongCompData
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
Cigi_int32 CigiShortCompCtrlV4::GetLongCompData(const unsigned int Word)
{
...
// GetFloatCompData
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
float CigiShortCompCtrlV4::GetFloatCompData(const unsigned int Word)
{
...
// GetI64CompData
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
Cigi_uint64 CigiShortCompCtrlV4::GetI64CompData(const unsigned int Pos)
{
...
// GetDoubleCompData
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
double CigiShortCompCtrlV4::GetDoubleCompData(const unsigned int Pos)
{
