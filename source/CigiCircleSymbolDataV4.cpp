...
CigiCircleSymbolDataV4::CigiCircleSymbolDataV4(void)
{
...
// Pack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiCircleSymbolDataV4::Pack(CigiBaseCircleSymbolData * Base, Cigi_uint8 * Buff) const
{
   PackPointer CDta;

   CigiCircleSymbolDataV4 * Data = ( CigiCircleSymbolDataV4 *)Base;
   ...
   *CDta.f++ = Data->EndAngle;
   ...
   return(CIGI_CIRCLE_SYMBOL_DATA_SIZE_V4);
...
// Unpack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiCircleSymbolDataV4::Unpack(Cigi_uint8 * Buff, bool Swap)
{
   PackPointer CDta;
