...
CigiEnvRgnCtrlV4::CigiEnvRgnCtrlV4()
{

   PacketID = CIGI_ENV_RGN_CTRL_PACKET_ID_V4;
   PacketSize = CIGI_ENV_RGN_CTRL_PACKET_SIZE_V4;
   Version = 4;
   MinorVersion = 0;
...
// Pack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiEnvRgnCtrlV4::Pack(CigiBasePacket * Base, Cigi_uint8 * Buff, void *Spec) const
{
   PackPointer CDta;
...
// Unpack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiEnvRgnCtrlV4::Unpack(Cigi_uint8 * Buff, bool Swap, void *Spec)
{
   PackPointer CDta;
