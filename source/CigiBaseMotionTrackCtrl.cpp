                                   ...
                                   CigiCnvtInfoType::Type &CnvtInfo)
{
   ...
   else if(CnvtVersion.CigiMajorVersion < 4)
   {
      ...
      CnvtInfo.CnvtPacketID = CIGI_MOTION_TRACK_CTRL_PACKET_ID_V3;
   }
   else
   {
      CnvtInfo.ProcID = CigiProcessType::ProcStd;
      CnvtInfo.CnvtPacketID = CIGI_MOTION_TRACK_CTRL_PACKET_ID_V4;
   }
   return(CIGI_SUCCESS);
}
...
// Scope
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiBaseMotionTrackCtrl::SetScope(const ScopeGrp ScopeIn, bool bndchk)
{

#ifndef CIGI_NO_BND_CHK
   if(bndchk && ((ScopeIn < 0)||(ScopeIn > 1)))
   {
#ifndef CIGI_NO_EXCEPT
      throw CigiValueOutOfRangeException("Scope",(ScopeGrp)ScopeIn,0,1);
#endif
