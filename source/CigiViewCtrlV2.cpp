...
CigiViewCtrlV2::CigiViewCtrlV2()
{
   ...
   PacketID = CIGI_VIEW_CTRL_PACKET_ID_V2;
   PacketSize = CIGI_VIEW_CTRL_PACKET_SIZE_V2;
   Version = 2;
   MinorVersion = 0;
...
// Pack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiViewCtrlV2::Pack(CigiBasePacket * Base, Cigi_uint8 * Buff, void *Spec) const
{
   double DBuf[6];
   ...
   *CDta.c++ = 0;
   ...
   memcpy(Buff,tBuf,CIGI_VIEW_CTRL_PACKET_SIZE_V2);
...
// Unpack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiViewCtrlV2::Unpack(Cigi_uint8 * Buff, bool Swap, void *Spec)
{
   double DBuf[6];
   ...
   memcpy(tBuf,Buff,CIGI_VIEW_CTRL_PACKET_SIZE_V2);
...
// ViewID
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiViewCtrlV2::SetViewID(const Cigi_uint8 ViewIDIn, bool bndchk)
{
...
// GroupID
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiViewCtrlV2::SetGroupID(const Cigi_uint8 GroupIDIn, bool bndchk)
{
