 ...
 *  
 *  FILENAME:   CigiCollDetVolDefV4.cpp
 *  LANGUAGE:   C++
 *  CLASS:      UNCLASSIFIED
 ...
 *  Based on CigiCollDetVolDefV4.cpp"
 *
 * </pre>
...
CigiCollDetVolDefV4::CigiCollDetVolDefV4()
{

   PacketID = CIGI_COLL_DET_VOL_DEF_PACKET_ID_V4;
   PacketSize = CIGI_COLL_DET_VOL_DEF_PACKET_SIZE_V4;
   Version = 4;
   MinorVersion = 0;
...
// Pack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiCollDetVolDefV4::Pack(CigiBasePacket * Base, Cigi_uint8 * Buff, void *Spec) const
{
   PackPointer CDta;
...
// Unpack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiCollDetVolDefV4::Unpack(Cigi_uint8 * Buff, bool Swap, void *Spec)
{
   PackPointer CDta;
...
// VolType
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiCollDetVolDefV4::SetVolType(const VolTypeGrp VolTypeIn, bool bndchk)
{
...
// Roll
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiCollDetVolDefV4::SetRoll(const float RollIn, bool bndchk)
{
...
// Pitch
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiCollDetVolDefV4::SetPitch(const float PitchIn, bool bndchk)
{
...
// Yaw
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiCollDetVolDefV4::SetYaw(const float YawIn, bool bndchk)
{
