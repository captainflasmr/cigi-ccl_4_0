...
CigiHatReqV1::CigiHatReqV1()
{
   ...
   PacketID = CIGI_HAT_REQ_PACKET_ID_V1;
   PacketSize = CIGI_HAT_REQ_PACKET_SIZE_V1;
   Version = 1;
   MinorVersion = 0;
...
// Pack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiHatReqV1::Pack(CigiBasePacket * Base, Cigi_uint8 * Buff, void *Spec) const
{
   double DBuf[6];
...
// Unpack
// vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
int CigiHatReqV1::Unpack(Cigi_uint8 * Buff, bool Swap, void *Spec)
{
   double DBuf[6];
   ...
   memcpy(tBuf,Buff,CIGI_HAT_REQ_PACKET_SIZE_V1);
