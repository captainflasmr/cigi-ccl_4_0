...
#if !defined(_CIGI_HAT_HOT_RESP_V3_INCLUDED_)
#define _CIGI_HAT_HOT_RESP_V3_INCLUDED_

#include "CigiBaseHatHotResp.h"



class CIGI_SPEC CigiHatHotRespV3 : public CigiBaseHatHotResp
{
...
#endif // #if !defined(_CIGI_HAT_HOT_RESP_V3_INCLUDED_)
