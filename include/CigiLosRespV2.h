...
#if !defined(_CIGI_LOS_RESP_V2_INCLUDED_)
#define _CIGI_LOS_RESP_V2_INCLUDED_

#include "CigiBaseLosResp.h"



class CIGI_SPEC CigiLosRespV2 : public CigiBaseLosResp
{
...
#endif // #if !defined(_CIGI_LOS_RESP_V2_INCLUDED_)
