...
#if !defined(_CIGI_SENSOR_CTRL_V4_INCLUDED_)
#define _CIGI_SENSOR_CTRL_V4_INCLUDED_

#include "CigiBaseSensorCtrl.h"



class CIGI_SPEC CigiSensorCtrlV4 : public CigiBaseSensorCtrl
{
...
#endif // #if !defined(_CIGI_SENSOR_CTRL_V4_INCLUDED_)
