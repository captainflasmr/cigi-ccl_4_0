...
#if !defined(_CIGI_HAT_HOT_RESP_V4_INCLUDED_)
#define _CIGI_HAT_HOT_RESP_V4_INCLUDED_

#include "CigiBaseHatHotResp.h"



class CIGI_SPEC CigiHatHotRespV4 : public CigiBaseHatHotResp
{
...
#endif // #if !defined(_CIGI_HAT_HOT_RESP_V4_INCLUDED_)
