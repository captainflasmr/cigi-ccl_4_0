...
#if !defined(_CIGI_LOS_SEG_REQ_V3_2_INCLUDED_)
#define _CIGI_LOS_SEG_REQ_V3_2_INCLUDED_

#include "CigiBaseLosSegReq.h"



class CIGI_SPEC CigiLosSegReqV3_2 : public CigiBaseLosSegReq
{
...
#endif // #if !defined(_CIGI_LOS_SEG_REQ_V3_2_INCLUDED_)
