...
#if !defined(_CIGI_VIEW_CTRL_V4_INCLUDED_)
#define _CIGI_VIEW_CTRL_V4_INCLUDED_

#include "CigiBaseViewCtrl.h"



class CIGI_SPEC CigiViewCtrlV4 : public CigiBaseViewCtrl
{
...
#endif // #if !defined(_CIGI_VIEW_CTRL_V4_INCLUDED_)
