...
#if !defined(_CIGI_SENSOR_CTRL_V2_INCLUDED_)
#define _CIGI_SENSOR_CTRL_V2_INCLUDED_

#include "CigiBaseSensorCtrl.h"



class CIGI_SPEC CigiSensorCtrlV2 : public CigiBaseSensorCtrl
{
...
#endif // #if !defined(_CIGI_SENSOR_CTRL_V2_INCLUDED_)
