 ...
 *  
 *  FILENAME:   CigiCelestialCtrlV4.h
 *  LANGUAGE:   C++
 *  CLASS:      UNCLASSIFIED
...
#if !defined(_CIGI_CELESTIAL_CTRL_V4_INCLUDED_)
#define _CIGI_CELESTIAL_CTRL_V4_INCLUDED_

#include "CigiBaseEnvCtrl.h"



class CIGI_SPEC CigiCelestialCtrlV4 : public CigiBaseEnvCtrl
{
...
public:
   ...
   //=========================================================
   //! Sets the Seconds with bound checking control
   //! \param SecondsIn - Current minute
   //! \param bndchk - Enables (true) or disables (false) bounds checking.
   //!
   //! \return This returns CIGI_SUCCESS or an error code
   //!   defined in CigiErrorCodes.h
   int SetSeconds(const float SecondsIn, bool bndchk=true);

   //=========================================================
   //! Gets the Minute value.
   //! \return the current Minute.
   float GetSeconds(void) const { return(Seconds); }
 ...
 //+> ContinuousTODEn
   ...
   //=========================================================
   //! Sets the TimeOfDayEn with bound checking control
   //! \param TimeOfDayEnIn - Ephereris model enable
   //! \param bndchk - Enables (true) or disables (false) bounds checking.
   //!
   //! \return This returns CIGI_SUCCESS or an error code
   //!   defined in CigiErrorCodes.h
   int SetContinuousTODEn(const bool ContinuousTimeOfDayEnIn, bool bndchk=true)
   {
      ContinuousTimeOfDayEn = ContinuousTimeOfDayEnIn;
      return(CIGI_SUCCESS);
   }

   //=========================================================
   //! Gets the TimeOfDayEn value.
   //! \return the current TimeOfDayEn.
   bool SetContinuousTODEn(void) const { return(ContinuousTimeOfDayEn); }
...
#endif // #if !defined(_CIGI_CELESTIAL_CTRL_V4_INCLUDED_)
