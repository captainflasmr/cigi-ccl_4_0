...
#if !defined(_CIGI_SHORT_COMP_CTRL_V4_INCLUDED_)
#define _CIGI_SHORT_COMP_CTRL_V4_INCLUDED_

#include "CigiBaseCompCtrl.h"



class CIGI_SPEC CigiShortCompCtrlV4 : public CigiBaseCompCtrl
{
...
#endif // #if !defined(_CIGI_SHORT_COMP_CTRL_V4_INCLUDED_)
