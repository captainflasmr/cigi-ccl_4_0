 ...
 *  
 *  FILENAME:   CigiEntityPositionCtrlV4.h
 *  LANGUAGE:   C++
 *  CLASS:      UNCLASSIFIED
...
#if !defined(_CIGI_ENTITY_POSITION_CONTROL_V4)
#define _CIGI_ENTITY_POSITION_CONTROL_V4
...
//!
class CIGI_SPEC CigiEntityPositionCtrlV4 : public CigiBaseEntityPositionCtrl  
{
...
public:
   ...
   //! General Destructor
   //!
	virtual ~CigiEntityPositionCtrlV4();
