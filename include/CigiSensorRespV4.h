...
#if !defined(_CIGI_SENSOR_RESP_V4_INCLUDED_)
#define _CIGI_SENSOR_RESP_V4_INCLUDED_

#include "CigiBaseSensorResp.h"



class CIGI_SPEC CigiSensorRespV4 : public CigiBaseSensorResp
{
...
#endif // #if !defined(_CIGI_SENSOR_RESP_V4_INCLUDED_)
