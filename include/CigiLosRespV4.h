...
#if !defined(_CIGI_LOS_RESP_V4_INCLUDED_)
#define _CIGI_LOS_RESP_V4_INCLUDED_

#include "CigiBaseLosResp.h"



class CIGI_SPEC CigiLosRespV4 : public CigiBaseLosResp
{
...
#endif // #if !defined(_CIGI_LOS_RESP_V4_INCLUDED_)
