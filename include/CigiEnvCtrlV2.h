...
#if !defined(_CIGI_ENV_CTRL_V2_INCLUDED_)
#define _CIGI_ENV_CTRL_V2_INCLUDED_

#include "CigiBaseEnvCtrl.h"



class CIGI_SPEC CigiEnvCtrlV2 : public CigiBaseEnvCtrl
{
...
public:
   ...
   //! \param AtmosEnIn - Enable (true) or disable (false)
   //!    the atmospheric effects model
   //! \param bndchk - Enables (true) or disables (false) bounds checking.
   //!
   //! \return This returns CIGI_SUCCESS or an error code
   //!   defined in CigiErrorCodes.h
   ...
   //! \param AerosolIn - percentage Aerosol content of the air.
   //! \param bndchk - Enables (true) or disables (false) bounds checking.
   //!
   //! \return This returns CIGI_SUCCESS or an error code
   //!   defined in CigiErrorCodes.h
...
#endif // #if !defined(_CIGI_ENV_CTRL_V2_INCLUDED_)
