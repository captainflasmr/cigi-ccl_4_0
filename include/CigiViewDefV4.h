...
#if !defined(_CIGI_VIEW_DEF_V4_INCLUDED_)
#define _CIGI_VIEW_DEF_V4_INCLUDED_

#include "CigiBaseViewDef.h"



class CIGI_SPEC CigiViewDefV4 : public CigiBaseViewDef
{
...
#endif // #if !defined(_CIGI_VIEW_DEF_V4_INCLUDED_)
