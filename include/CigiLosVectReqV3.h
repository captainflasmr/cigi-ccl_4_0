...
#if !defined(_CIGI_LOS_VECT_REQ_V3_INCLUDED_)
#define _CIGI_LOS_VECT_REQ_V3_INCLUDED_

#include "CigiBaseLosVectReq.h"



class CIGI_SPEC CigiLosVectReqV3 : public CigiBaseLosVectReq
{
...
#endif // #if !defined(_CIGI_LOS_VECT_REQ_V3_INCLUDED_)
