...
#if !defined(_CIGI_SENSOR_XRESP_V4_INCLUDED_)
#define _CIGI_SENSOR_XRESP_V4_INCLUDED_

#include "CigiBaseSensorResp.h"



class CIGI_SPEC CigiSensorXRespV4 : public CigiBaseSensorResp
{
...
#endif // #if !defined(_CIGI_SENSOR_XRESP_V4_INCLUDED_)
