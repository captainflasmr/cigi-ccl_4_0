...
#if !defined(_CIGI_ART_PART_CTRL_V4_INCLUDED_)
#define _CIGI_ART_PART_CTRL_V4_INCLUDED_

#include "CigiBaseArtPartCtrl.h"


class CIGI_SPEC CigiArtPartCtrlV4 : public CigiBaseArtPartCtrl
{
...
#endif // #if !defined(_CIGI_ART_PART_CTRL_V4_INCLUDED_)
