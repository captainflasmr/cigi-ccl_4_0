...
#if !defined(_CIGI_IG_CTRL_V1_INCLUDED_)
#define _CIGI_IG_CTRL_V1_INCLUDED_
...
//=========================================================
//! The class for the IG Control packet for CIGI version 1
//!
class CIGI_SPEC CigiIGCtrlV1 : public CigiBaseIGCtrl  
{
public:
	CigiIGCtrlV1();
   ...
   //! \return TimeStampV1 The timestamp value
   //!
   Cigi_uint32 GetTimeStamp(void) const { return(TimeStampV1); }

   //=========================================================
   //! Sets the Timestamp value for V1.<br>
   ...
   //=========================================================
   //! Sets the Tracking Device Enable flag for V1.<br>
   ...
   //=========================================================
   //! Sets the Boresight Tracking Device flag for V1.<br>
...
#endif // !defined(_CIGI_IG_CTRL_V1_INCLUDED_)
