...
#if !defined(_CIGI_IG_CONTROL_V3_3_INCLUDED_)
#define _CIGI_IG_CONTROL_V3_3_INCLUDED_
...
//!
class CIGI_SPEC CigiIGCtrlV3_3 : public CigiBaseIGCtrl  
{
public:
	CigiIGCtrlV3_3();
...
#endif // !defined(_CIGI_IG_CONTROL_V3_3_INCLUDED_)
