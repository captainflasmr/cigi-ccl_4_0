 ...
 *  
 *  FILENAME:   CigiSymbolCircleDefV4.h
 *  LANGUAGE:   C++
 *  CLASS:      UNCLASSIFIED
...
#if !defined(_CIGI_SYMBOL_CIRCLE_DEF_V4_INCLUDED_)
#define _CIGI_SYMBOL_CIRCLE_DEF_V4_INCLUDED_


#include "CigiBaseSymbolCircleDef.h"
#include "CigiCircleSymbolDataV4.h"
...
//!
class CIGI_SPEC CigiSymbolCircleDefV4 :
...
public:
   ...
   //! General Constructor
   //!
   CigiSymbolCircleDefV4(void);

   //=========================================================
   //! General Destructor
   //!
   virtual ~CigiSymbolCircleDefV4(void);

   //=========================================================
   //! Copy Constructor
   //!
   CigiSymbolCircleDefV4(const CigiSymbolCircleDefV4 &BaseIn);

   //=========================================================
   //! Assignment operator
   //!
   CigiSymbolCircleDefV4 & operator=(const CigiSymbolCircleDefV4 &BaseIn);
...
#endif   //  #if !defined(_CIGI_SYMBOL_CIRCLE_DEF_V4_INCLUDED_)
