...
#if !defined(_CIGI_LOS_SEG_REQ_V4_INCLUDED_)
#define _CIGI_LOS_SEG_REQ_V4_INCLUDED_

#include "CigiBaseLosSegReq.h"



class CIGI_SPEC CigiLosSegReqV4 : public CigiBaseLosSegReq
{
...
public:
   ...
   //! \param DestEntityIDValidIn - Specifies whether the destination
   //!   entity's ID is a valid value.<br>
   //! \param bndchk - Enables (true) or disables (false) bounds checking.
   //!
   //! \return This returns CIGI_SUCCESS or an error code
   //!   defined in CigiErrorCodes.h
   ...
   {
      DestEntityIDValid = DestEntityIDValidIn;
      return(CIGI_SUCCESS);
   }

   //=========================================================
   //! Gets the DestEntityIDValid value.
   //! \return the current DestEntityIDValid.
   bool GetDestEntityIDValid(void) const { return(DestEntityIDValid); }
   ...
   //! \param DestEntityIDIn - The destination entity's ID.
   //! \param bndchk - Enables (true) or disables (false) bounds checking.
   //!
   //! \return This returns CIGI_SUCCESS or an error code
   //!   defined in CigiErrorCodes.h
   ...
   //! Gets the Mask value.
   //! \return the current Mask.
   Cigi_uint16 GetDestEntityID(void) const { return(DestEntityID); }



};

#endif // #if !defined(_CIGI_LOS_SEG_REQ_V4_INCLUDED_)
