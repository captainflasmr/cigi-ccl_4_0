 ...
 *  Based on CigiBaseCollDetVolDef.h"
 *  
 * </pre>
...
#if !defined(_CIGI_COLL_DET_VOL_DEF_V4_INCLUDED_)
#define _CIGI_COLL_DET_VOL_DEF_V4_INCLUDED_

#include "CigiBaseCollDetVolDef.h"



class CIGI_SPEC CigiCollDetVolDefV4 : public CigiBaseCollDetVolDef
{
...
#endif // #if !defined(_CIGI_COLL_DET_VOL_DEF_V4_INCLUDED_)
