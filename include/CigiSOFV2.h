...
#if !defined(_CIGI_SOF_V2_INCLUDED_)
#define _CIGI_SOF_V2_INCLUDED_
...
//=========================================================
//! The class for the Start Of Frame packet for CIGI version 2
//!
class CIGI_SPEC CigiSOFV2 : public CigiBaseSOF  
{
public:
	CigiSOFV2();
	virtual ~CigiSOFV2();
   ...
   //! \param TimeStamp - Specifies the timestamp in microseconds.
   //! \param bndchk - Enables (true) or disables (false) bounds checking.
   //!
   //! \return This returns CIGI_SUCCESS or an error code 
   //!   defined in CigiErrorCodes.h
...
#endif // !defined(_CIGI_SOF_V2_INCLUDED_)
