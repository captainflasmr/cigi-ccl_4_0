...
#if !defined(_CIGI_HAT_RESP_V1_INCLUDED_)
#define _CIGI_HAT_RESP_V1_INCLUDED_

#include "CigiBaseHatHotResp.h"


class CIGI_SPEC CigiHatRespV1 : public CigiBaseHatHotResp
{
...
public:
   ...
   //! \param HatIn - The Hat result data.
...
#endif // #if !defined(_CIGI_HAT_HOT_RESP_V1_INCLUDED_)
