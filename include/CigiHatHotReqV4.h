...
#if !defined(_CIGI_HAT_HOT_REQ_V4_INCLUDED_)
#define _CIGI_HAT_HOT_REQ_V4_INCLUDED_

#include "CigiBaseHatHotReq.h"



class CIGI_SPEC CigiHatHotReqV4 : public CigiBaseHatHotReq
{
...
#endif // #if !defined(_CIGI_HAT_HOT_REQ_V4_INCLUDED_)
