...
#define _CIGI_SYMBOL_TEXT_DEF_V3_3_INCLUDED_
...
//!
class CIGI_SPEC CigiSymbolTextDefV3_3 :
   public CigiBaseSymbolTextDef
{
public:
   ...
   {
      return((CigiSymbolTextDefV3_3 &)CigiBaseSymbolTextDef::operator=((CigiBaseSymbolTextDef &)BaseIn));
   }
...
#endif   //  #if !defined(_CIGI_SYMBOL_TEXT_DEF_V3_3_INCLUDED_)
