...
#if !defined(_CIGI_COLL_DET_SEG_DEF_V3_INCLUDED_)
...
class CIGI_SPEC CigiCollDetSegDefV3 : public CigiBaseCollDetSegDef
{
...
#endif // #if !defined(_CIGI_COLL_DET_SEG_DEF_V3_INCLUDED_)
