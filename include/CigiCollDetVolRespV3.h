...
#if !defined(_CIGI_COLL_DET_VOL_RESP_V3_INCLUDED_)
#define _CIGI_COLL_DET_VOL_RESP_V3_INCLUDED_

#include "CigiBaseCollDetVolResp.h"



class CIGI_SPEC CigiCollDetVolRespV3 : public CigiBaseCollDetVolResp
{
...
#endif // #if !defined(_CIGI_COLL_DET_VOL_RESP_V3_INCLUDED_)
