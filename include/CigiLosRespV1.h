...
#if !defined(_CIGI_LOS_RESP_V1_INCLUDED_)
#define _CIGI_LOS_RESP_V1_INCLUDED_

#include "CigiBaseLosResp.h"


class CIGI_SPEC CigiLosRespV1 : public CigiBaseLosResp
{
...
#endif // #if !defined(_CIGI_LOS_RESP_V1_INCLUDED_)
