...
#if !defined(_CIGI_WEATHER_CTRL_V4_INCLUDED_)
#define _CIGI_WEATHER_CTRL_V4_INCLUDED_

#include "CigiBaseWeatherCtrl.h"



class CIGI_SPEC CigiWeatherCtrlV4 : public CigiBaseWeatherCtrl
{
...
public:
  ...
  //+> BottomScudEn
   ...
   //=========================================================
   //! Sets the BottomScudEn with bound checking control
   //! \param BottomScudEnIn - Bottom Scud enable(true)/disable(false)
   //! \param bndchk - Enables (true) or disables (false) bounds checking.
   //!
   //! \return This returns CIGI_SUCCESS or an error code
   //!   defined in CigiErrorCodes.h
   int SetBottomScudEn(const bool bottomScudEnIn, bool bndchk=true)
   {
      ScudEn = bottomScudEnIn;
      return(CIGI_SUCCESS);
   }
   ...
   bool GetBottomScudEn(void) const { return(ScudEn); }


   //+> BottomScudFreq

   //=========================================================
   //! Sets the Bottom ScudFreq with bound checking control
   //! \param BottomScudFreqIn - Bottom Scud coverage percentage
   //! \param bndchk - Enables (true) or disables (false) bounds checking.
   //!
   //! \return This returns CIGI_SUCCESS or an error code
   //!   defined in CigiErrorCodes.h
   int SetBottomScudFreq(const float BottomScudFreqIn, bool bndchk=true);

   //=========================================================
   //! Gets the Bottom ScudFreq value.
   //! \return the current ScudFreq.

   float GetBottomScudFreq(void) const { return(ScudFreq); }

   //+> BottomThickness

   //=========================================================
   //! Sets the Bottom Transition Band Thickness with bound checking control
   //! \param BottomThicknessIn - Thickness or height of the cloud bottom transition
   //! \param bndchk - Enables (true) or disables (false) bounds checking.
   //!
   //! \return This returns CIGI_SUCCESS or an error code
   //!   defined in CigiErrorCodes.h
   int SetBottomTransition(const float BottomTransitionIn, bool bndchk=true)
   {
      Transition = BottomTransitionIn;
      return(CIGI_SUCCESS);
   }
   ...
   float GetBottomTransition(void) const { return(Transition); }
  ...
  //+> TopScudEn
   ...
   //=========================================================
   //! Sets the TopScudEn with bound checking control
   //! \param TopScudEnIn - Top Scud enable(true)/disable(false)
   //! \param bndchk - Enables (true) or disables (false) bounds checking.
   //!
   //! \return This returns CIGI_SUCCESS or an error code
   //!   defined in CigiErrorCodes.h
   int SetTopScudEn(const bool TopScudEnIn, bool bndchk=true)
   {
      TopScudEn = TopScudEnIn;
      return(CIGI_SUCCESS);
   }

   //=========================================================
   //! Gets the TopScudEn value.
   //! \return the current ScudEn.
   bool GetTopScudEn(void) const { return(TopScudEn); }

   //+> TopScudFreq

   //=========================================================
   //! Sets the TopScudFreqIn with bound checking control
   //! \param TopScudFreqIn - Top Scud coverage percentage
   //! \param bndchk - Enables (true) or disables (false) bounds checking.
   //!
   //! \return This returns CIGI_SUCCESS or an error code
   //!   defined in CigiErrorCodes.h
   int SetTopScudFreq(const float TopScudFreqIn, bool bndchk=true);

   //=========================================================
   //! Gets the TopScudFreq value.
   //! \return the current ScudFreq.

   float GetTopScudFreq(void) const { return(TopScudFreq); }

   //+> TopScudThickness

   //=========================================================
   //! Sets the TopThickness with bound checking control
   //! \param TopThicknessIn - Thickness or height of the cloud top transition
   //! \param bndchk - Enables (true) or disables (false) bounds checking.
   //!
   //! \return This returns CIGI_SUCCESS or an error code
   //!   defined in CigiErrorCodes.h
   int SetTopTransition(const float TopTransitionIn, bool bndchk=true)
   {
      TopTransition = TopTransitionIn;
      return(CIGI_SUCCESS);
   }

   //=========================================================
   //! Gets the TopThickness value.
   //! \return the current Thickness.
   float GetTopTransition(void) const { return(TopTransition); }

};

#endif // #if !defined(_CIGI_WEATHER_CTRL_V4_INCLUDED_)
