...
#if !defined(_CIGI_LOS_RESP_V3_INCLUDED_)
#define _CIGI_LOS_RESP_V3_INCLUDED_

#include "CigiBaseLosResp.h"



class CIGI_SPEC CigiLosRespV3 : public CigiBaseLosResp
{
...
#endif // #if !defined(_CIGI_LOS_RESP_V3_INCLUDED_)
