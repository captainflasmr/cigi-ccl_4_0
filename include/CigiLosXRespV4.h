...
#if !defined(_CIGI_LOS_XRESP_V4_INCLUDED_)
#define _CIGI_LOS_XRESP_V4_INCLUDED_

#include "CigiBaseLosResp.h"



class CIGI_SPEC CigiLosXRespV4 : public CigiBaseLosResp
{
...
#endif // #if !defined(_CIGI_LOS_XRESP_V4_INCLUDED_)
