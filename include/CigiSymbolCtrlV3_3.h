...
#if !defined(_CIGI_SYMBOL_CTRL_V3_3_INCLUDED_)
#define _CIGI_SYMBOL_CTRL_V3_3_INCLUDED_
...
//!
class CIGI_SPEC CigiSymbolCtrlV3_3 :
   public CigiBaseSymbolCtrl
{
public:
...
#endif   //  #if !defined(_CIGI_SYMBOL_CTRL_V3_3_INCLUDED_)
