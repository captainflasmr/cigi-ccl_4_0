...
#if !defined(_CIGI_VIEW_CTRL_V2_INCLUDED_)
#define _CIGI_VIEW_CTRL_V2_INCLUDED_

#include "CigiBaseViewCtrl.h"



class CIGI_SPEC CigiViewCtrlV2 : public CigiBaseViewCtrl
{
...
#endif // #if !defined(_CIGI_VIEW_CTRL_V2_INCLUDED_)
