...
#if !defined(_CIGI_ATMOS_CTRL_V4_INCLUDED_)
#define _CIGI_ATMOS_CTRL_V4_INCLUDED_

#include "CigiBaseEnvCtrl.h"



class CIGI_SPEC CigiAtmosCtrlV4 : public CigiBaseEnvCtrl
{
...
#endif // #if !defined(_CIGI_ENV_CTRL_V4_INCLUDED_)
