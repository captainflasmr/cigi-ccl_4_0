...
#if !defined(_CIGI_LOS_VECT_REQ_V1_INCLUDED_)
#define _CIGI_LOS_VECT_REQ_V1_INCLUDED_

#include "CigiBaseLosVectReq.h"


class CIGI_SPEC CigiLosVectReqV1 : public CigiBaseLosVectReq
{
...
#endif // #if !defined(_CIGI_LOS_VECT_REQ_V1_INCLUDED_)
