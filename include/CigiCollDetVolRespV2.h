...
#if !defined(_CIGI_COLL_DET_VOL_RESP_V2_INCLUDED_)
#define _CIGI_COLL_DET_VOL_RESP_V2_INCLUDED_

#include "CigiBaseCollDetVolResp.h"


class CIGI_SPEC CigiCollDetVolRespV2 : public CigiBaseCollDetVolResp
{
...
#endif // #if !defined(_CIGI_COLL_DET_VOL_RESP_V2_INCLUDED_)
