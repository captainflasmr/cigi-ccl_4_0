...
#if !defined(_CIGI_WEATHER_CTRL_V1_INCLUDED_)
#define _CIGI_WEATHER_CTRL_V1_INCLUDED_

#include "CigiBaseWeatherCtrl.h"


class CIGI_SPEC CigiWeatherCtrlV1 : public CigiBaseWeatherCtrl
{
...
#endif // #if !defined(_CIGI_WEATHER_CTRL_V1_INCLUDED_)
