...
#if !defined(_CIGI_IG_CONTROL_V4_INCLUDED_)
#define _CIGI_IG_CONTROL_V4_INCLUDED_
...
//=========================================================
//! The class for the IG Control packet for CIGI version 4
//!
class CIGI_SPEC CigiIGCtrlV4 : public CigiBaseIGCtrl  
{
public:
	CigiIGCtrlV4();
	virtual ~CigiIGCtrlV4();
   ...
   //+> Entity Type Subdtitution Enabled
   //=========================================================
   //! Gets the Entity Type Subdtitution Enabled flag
   //! \return Entity Type Subdtitution Enabled flag
   //!
   bool GetEntityTypeSubEn(void) const { return(EntityTypeSubEn); }

   //=========================================================
   //! Enables or Disables motion smoothing.<br>
   //! \param SubstitutionEnabled - Enables (true) or disables (false)
   //!    Entity Type Subdtitution
   //! \param bndchk - Enables (true) or disables (false) bounds checking
   //!
   //! \return This returns CIGI_SUCCESS or an error code 
   //!   defined in CigiErrorCodes.h
   //!
	int SetEntityTypeSubEn(const bool SubstitutionEnabled, bool bndchk=true)
   {
      EntityTypeSubEn = SubstitutionEnabled;
   ...
   //=========================================================
   //! Gets the Smoothing Enabled flag for V4.0
...
#endif // !defined(_CIGI_IG_CONTROL_V4_INCLUDED_)
