...
#if !defined(_CIGI_IG_MSG_V3_INCLUDED_)
#define _CIGI_IG_MSG_V3_INCLUDED_

#include "CigiBaseIGMsg.h"



class CIGI_SPEC CigiIGMsgV3 : public CigiBaseIGMsg
{
...
#endif // #if !defined(_CIGI_IG_MSG_V3_INCLUDED_)
