...
#if !defined(_CIGI_TRAJECTORY_DEF_V3_INCLUDED_)
#define _CIGI_TRAJECTORY_DEF_V3_INCLUDED_

#include "CigiBaseTrajectoryDef.h"



class CIGI_SPEC CigiTrajectoryDefV3 : public CigiBaseTrajectoryDef
{
...
#endif // #if !defined(_CIGI_TRAJECTORY_DEF_V3_INCLUDED_)
