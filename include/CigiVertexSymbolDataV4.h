 ...
 *  
 *  FILENAME:   CigiVertexSymbolDataV4.h
 *  LANGUAGE:   C++
 *  CLASS:      UNCLASSIFIED
...
#if !defined(_CIGI_VERTEX_SYMBOL_DATA_V4_INCLUDED_)
#define _CIGI_VERTEX_SYMBOL_DATA_V4_INCLUDED_
...
//!
class CIGI_SPEC CigiVertexSymbolDataV4 :
   public CigiBaseVertexSymbolData
{
...
public:
   ...
   //! General Constructor
   //!
   CigiVertexSymbolDataV4(void);

   //=========================================================
   //! General Destructor
   //!
   virtual ~CigiVertexSymbolDataV4(void);
...
#endif   //  #if !defined(_CIGI_VERTEX_SYMBOL_DATA_V4_INCLUDED_)
