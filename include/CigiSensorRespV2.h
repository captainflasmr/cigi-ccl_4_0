...
#if !defined(_CIGI_SENSOR_RESP_V2_INCLUDED_)
#define _CIGI_SENSOR_RESP_V2_INCLUDED_

#include "CigiBaseSensorResp.h"



class CIGI_SPEC CigiSensorRespV2 : public CigiBaseSensorResp
{
...
#endif // #if !defined(_CIGI_SENSOR_RESP_V2_INCLUDED_)
