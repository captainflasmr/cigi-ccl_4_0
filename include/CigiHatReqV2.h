...
#if !defined(_CIGI_HAT_REQ_V2_INCLUDED_)
#define _CIGI_HAT_REQ_V2_INCLUDED_

#include "CigiBaseHatHotReq.h"



class CIGI_SPEC CigiHatReqV2 : public CigiBaseHatHotReq
{
...
public:
   ...
   //! \param AltIn - The referance altitude
...
#endif // #if !defined(_CIGI_HAT_REQ_V2_INCLUDED_)
