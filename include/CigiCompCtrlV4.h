...
#if !defined(_CIGI_COMP_CTRL_V4_INCLUDED_)
#define _CIGI_COMP_CTRL_V4_INCLUDED_

#include "CigiBaseCompCtrl.h"



class CIGI_SPEC CigiCompCtrlV4 : public CigiBaseCompCtrl
{
...
public:
   ...
   {
      Cigi_uint8 V4State = (Cigi_uint8)((CompState > 0x00ff) ? 0xff : CompState);
      return(V4State);
   }
   ...
   //=========================================================
   //! Sets the CompClassV4 with bound checking control
   //! \param CompClassV4In - <br>
   //!   EntityV4=0<br>
   //!   ViewV4=1<br>
   //!   ViewGrpV4=2<br>
   //!   SensorV4=3<br>
   //!   RegionalSeaSurfaceV4=4<br>
   //!   RegionalTerrainSurfaceV4=5<br>
   //!   RegionalLayeredWeatherV4=6<br>
   //!   GlobalSeaSurfaceV4=7<br>
   //!   GlobalTerrainSurfaceV4=8<br>
   //!   GlobalLayeredWeatherV4=9<br>
   //!   AtmosphereV4=10<br>
   //!   CelestialSphereV4=11<br>
   //!   EventV4=12<br>
   //!   SystemV4=13<br>
   //!   SymbolSurfaceV4=14<br>
   //!   SymbolV4=15<br>
   //! \param bndchk - Enables (true) or disables (false) bounds checking.
   //!
   //! \return This returns CIGI_SUCCESS or an error code
   //!   defined in CigiErrorCodes.h
   int SetCompClassV4(const CompClassV4Grp CompClassV4In, bool bndchk=true);
   int SetCompClassV3(const CompClassV3Grp CompClassV3In, bool bndchk = true);

   //=========================================================
   //! Gets the CompClassV4 value.
   //! \return the current CompClassV4.
   CompClassV4Grp GetCompClassV4(void) const { return((CompClassV4Grp)CompClassV3); }
...
#endif // #if !defined(_CIGI_COMP_CTRL_V4_INCLUDED_)
