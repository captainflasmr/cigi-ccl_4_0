...
#if !defined(_CIGI_COLL_DET_SEG_RESP_V2_INCLUDED_)
#define _CIGI_COLL_DET_SEG_RESP_V2_INCLUDED_

#include "CigiBaseCollDetSegResp.h"



class CIGI_SPEC CigiCollDetSegRespV2 : public CigiBaseCollDetSegResp
{
...
public:
   ...
   //! \param CollEntityIDIn - Entity ID of the entity collided with.
   //! \param bndchk - Enables (true) or disables (false) bounds checking.
   //!
   //! \return This returns CIGI_SUCCESS or an error code
   //!   defined in CigiErrorCodes.h
...
#endif // #if !defined(_CIGI_COLL_DET_SEG_RESP_V2_INCLUDED_)
