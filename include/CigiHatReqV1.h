...
#if !defined(_CIGI_HAT_REQ_V1_INCLUDED_)
#define _CIGI_HAT_REQ_V1_INCLUDED_

#include "CigiBaseHatHotReq.h"


class CIGI_SPEC CigiHatReqV1 : public CigiBaseHatHotReq
{
...
#endif // #if !defined(_CIGI_HAT_REQ_V1_INCLUDED_)
