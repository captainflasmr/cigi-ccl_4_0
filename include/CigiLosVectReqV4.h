...
#if !defined(_CIGI_LOS_VECT_REQ_V4_INCLUDED_)
#define _CIGI_LOS_VECT_REQ_V4_INCLUDED_

#include "CigiBaseLosVectReq.h"



class CIGI_SPEC CigiLosVectReqV4 : public CigiBaseLosVectReq
{
...
#endif // #if !defined(_CIGI_LOS_VECT_REQ_V4_INCLUDED_)
