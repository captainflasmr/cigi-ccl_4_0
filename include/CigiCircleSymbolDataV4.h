...
#if !defined(_CIGI_CIRCLE_SYMBOL_DATA_V4_INCLUDED_)
#define _CIGI_CIRCLE_SYMBOL_DATA_V4_INCLUDED_
...
//!
class CIGI_SPEC CigiCircleSymbolDataV4 :
...
public:
   ...
   //! General Constructor
   //!
   CigiCircleSymbolDataV4(void);

   //=========================================================
   //! General Destructor
   //!
   virtual ~CigiCircleSymbolDataV4(void);
...
#endif   //  #if !defined(_CIGI_CIRCLE_SYMBOL_DATA_V4_INCLUDED_)
