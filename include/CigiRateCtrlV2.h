...
#if !defined(_CIGI_RATE_CTRL_V2_INCLUDED_)
#define _CIGI_RATE_CTRL_V2_INCLUDED_

#include "CigiBaseRateCtrl.h"



class CIGI_SPEC CigiRateCtrlV2 : public CigiBaseRateCtrl
{
...
public:
   ...
   //! \return the current ArtPartIDV1.
...
#endif // #if !defined(_CIGI_RATE_CTRL_V2_INCLUDED_)
