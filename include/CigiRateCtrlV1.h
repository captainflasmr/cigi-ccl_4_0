...
#if !defined(_CIGI_RATE_CTRL_V1_INCLUDED_)
#define _CIGI_RATE_CTRL_V1_INCLUDED_

#include "CigiBaseRateCtrl.h"


class CIGI_SPEC CigiRateCtrlV1 : public CigiBaseRateCtrl
{
...
#endif // #if !defined(_CIGI_RATE_CTRL_V1_INCLUDED_)
