...
#if !defined(_CIGI_SYMBOL_CLONE_V3_3_INCLUDED_)
#define _CIGI_SYMBOL_CLONE_V3_3_INCLUDED_
...
//!
class CIGI_SPEC CigiSymbolCloneV3_3 :
   public CigiBaseSymbolClone
{
public:
...
#endif   //  #if !defined(_CIGI_SYMBOL_CLONE_V3_3_INCLUDED_)
